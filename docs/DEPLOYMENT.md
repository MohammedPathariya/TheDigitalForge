...
The repository pins Python in `.python-version` and `runtime.txt`, and the Render
blueprint also sets `PYTHON_VERSION=3.11.12`. Do not use Render's default Python version.
